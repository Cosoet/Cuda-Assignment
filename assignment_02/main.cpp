...
int main(int argc, char **argv) {
  ...
  std::cerr << "load the image and give us our input and output pointers" << std::endl;
  /*system("pause");*/
  ...
  std::cerr << "call the students' code" << std::endl;
  //system("pause");
  ...
  std::cerr << "done students' code" << std::endl;
  system("pause");
  if (err < 0) {
