                   ...
                   const float* const filter, const int filterWidth)
{
	...
	//		if (imagex >= numCols) imagex = numCols-1;
	//		if (imagey >= numRows) imagey = numRows - 1;
	//		//imagex = min(max(imagex, 0), numCols - 1);
	//		//imagey = min(max(imagey, 0), numRows - 1);
	//		c += (filter[fy*filterWidth + fx] * inputChannel[imagey*numCols + imagex]);
	//	}
	...
	////if (_x >= numCols || _y >= numRows)
	////	return;

	////redChannel[pixel_pos] = rgba.x;
	////greenChannel[pixel_pos] = rgba.y;
	////blueChannel[pixel_pos] = rgba.z;
 // // TODO
 // 
                      ...
                      unsigned char* const blueChannel)
{
  ...
  // }
	...
	//greyImage[pixel_pos] = channelSum;
